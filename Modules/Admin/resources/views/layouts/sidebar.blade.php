<div class="app-menu navbar-menu">
  ...
  <div class="navbar-brand-box">
      <!-- Dark Logo-->
      <a href="{{ route('admin.dashboard.home') }}" class="logo logo-dark">
              <span class="logo-sm">
      ...
      <!-- Light Logo-->
      <a href="{{ route("admin.dashboard.home") }}" class="logo logo-light">
              <span class="logo-sm">
                  <img src="{{ asset('assets/auth/images/users/avatar-1.jpg') }}" alt="" height="22">
              </span>
          <span class="logo-lg">
  ...
  <div id="scrollbar">
      <div class="container-fluid">
          ...
          <ul class="navbar-nav" id="navbar-nav">
              <li class="menu-title"><span data-key="t-menu">Mozayn</span></li>
              <li class="nav-item">
...
{{--                  </div>--}}
              ...
              <li class="nav-item">
                  <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                      <i class="ri-user-2-line"></i> <span data-key="t-apps"> Users </span>
                  </a>
...
{{--                          </li>--}}
                          ...
                          <li class="nav-item">
                              <a href="{{route("admin.dashboard.providers")}}" class="nav-link"> <span>Providers</span></a>
                          </li>

                          <li class="nav-item">
                              <a href="{{"#"}}" class="nav-link"> <span>Staffers </span></a>
                          </li>
                      </ul>
                  </div>
              </li>
...
{{--              </li> <!-- end Dashboard Menu -->--}}
              ...
              <li class="menu-title"><i class="ri-more-fill"></i> <span>Navigation </span></li>
