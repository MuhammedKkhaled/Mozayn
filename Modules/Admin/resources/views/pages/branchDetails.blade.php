        ...
        <div class="container-fluid">
            <div class="profile-foreground position-relative mx-n4 mt-n4">
                <div class="profile-wid-bg">
                    <img src="{{ asset("assets/auth/images/profile-bg.jpg") }}" alt="" class="profile-wid-img" />
                </div>
            </div>
            <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                <div class="row g-4">
                    <div class="col-auto">
                        <div class="avatar-lg">
                            <img src="{{ asset("assets/auth/images/users/avatar-1.jpg") }}" alt="user-img" class="img-thumbnail rounded-circle" />
                        </div>
                    </div>
                    <!--end col-->
                    <div class="col">
                        <div class="p-2">
                            <h3 class="text-white mb-1">{{ $branch->provider->name  }}</h3>
                            <p class="text-white text-opacity-75">Owner & Founder</p>
                            <div class="hstack text-white-50 gap-1">
                                <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $branch->branch_location }}</div>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
                            ...
                            <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab">
                                        <i class="ri-list-unordered d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block"> Staff</span>
                                    </a>
                                </li>
{{--                                <li class="nav-item">--}}
...
{{--                                </li>--}}
                            ...
                            <div class="flex-shrink-0">
                                {{--TODO:: make page For Edit/Modify The page --}}
...
{{--                                            </div>--}}
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title mb-3">Branch Info</h5>
                                                <div class="table-responsive">
                                                    <table class="table table-borderless mb-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $branch->branch_location }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Started Date</th>
                                                            <td class="text-muted">{{ $branch->created_at->format("M d, H:i a") }}</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex flex-wrap gap-2 fs-15">
                                                    <a href="javascript:void(0);" class="badge bg-primary-subtle text-primary">Haircut </a>
